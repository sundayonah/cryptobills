 ...
 * Polygon and Arbitrum use execute-sponsored for Privy embedded wallet (delegation contract per chain).
 */

/** Chain IDs that use the execute-sponsored API (batch + optional EIP-7702). Base is excluded. */
export const EXECUTE_SPONSORED_CHAIN_IDS: number[] = [137, 42161];
...
export const DELEGATION_CONTRACT_BY_CHAIN: Record<number, string> = {
  ...
  42161: "0x7598e608E9daa95d38EE40C2Bf1A96D1763b0369",
  56: "0x59288AC5c262B71b631Be6742967261526E00d59",
  // 137: "0x97b4e402db6DB09F067B6E085B84c95176499d16",
  137: "0x97B652C99467DAA109630B61510c2f2D0Cb45443",
